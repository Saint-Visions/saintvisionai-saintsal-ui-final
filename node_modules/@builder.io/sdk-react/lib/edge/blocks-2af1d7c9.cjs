...
`):s+("  at "+a+`
`)}e.g(t,"stack",s.trim(),y)}b.ha=function(){var e=this.ha.Mb;return e||(e=new Blob([Pn.join(`
...
function main()`).replace(/\?\./g,"."),Mr=e=>e+"JSON",zn=({builder:e,context:t,event:n,rootState:r,localState:o,rootSetState:s,code:a})=>{const f=Ft({rootState:r,localState:o,rootSetState:s}),d=Gr({builder:e,context:t,event:n,state:f}),v=d.map(([O])=>{const N=Mr(O);return O==="state"?"":`var ${O} = ${N} === undefined ? undefined : JSON.parse(${N});`}).join(`
`),T=Hn(a);if(T==="")return;const I=`
...
theFunction();
`,G=function(O,N){d.forEach(([_,C])=>{if(_==="state")O.setProperty(N,_,O.createConnectedObject(C),O.READONLY_DESCRIPTOR);else{const ce=JSON.stringify(C);O.setProperty(N,Mr(_),ce)}})},H=new h(I,G);return H.run(),H.pseudoToNative(H.value)};function Jn(){var e;return typeof process!="undefined"&&W.checkIsDefined((e=process==null?void 0:process.versions)==null?void 0:e.node)}const Kn=({shouldLogWarning:e})=>{var o;if(!Jn())return!1;const t=process.arch==="arm64",n=process.version.startsWith("v20"),r=(o=process.env.NODE_OPTIONS)==null?void 0:o.includes("--no-node-snapshot");return t&&n&&!r?(e&&W.logger.log("Skipping usage of `isolated-vm` to avoid crashes in Node v20 on an arm64 machine.\n    If you would like to use the `isolated-vm` package on this machine, please provide the `NODE_OPTIONS=--no-node-snapshot` config to your Node process.\n    See https://github.com/BuilderIO/builder/blob/main/packages/sdks/README.md#node-v20--m1-macs-apple-silicon-support for more information.\n    "),!0):!1},Yn=e=>W.isBrowser()||Kn({shouldLogWarning:!0})?In(e):zn(e),Zn=/^(return )?(\s*)?state(?<getPath>(\.\w+)+)(\s*);?$/,qn=/(\s)*var(\s)+_virtual_index(\s)*=(\s)*state(?<getPath>(\.\w+)+)(\s*);?(\s)*return(\s)*_virtual_index(\s)*/,Qn=e=>{var t,n,r,o,s,a;return((r=(n=(t=Zn.exec(e.trim()))==null?void 0:t.groups)==null?void 0:n.getPath)==null?void 0:r.slice(1))||((a=(s=(o=qn.exec(e.trim()))==null?void 0:o.groups)==null?void 0:s.getPath)==null?void 0:a.slice(1))};function Ye({code:e,context:t,localState:n,rootState:r,rootSetState:o,event:s,isExpression:a=!0}){if(e.trim()==="")return;const f=Qn(e.trim());if(f)return Wr({...r,...n},f);const d={code:An(e,{isExpression:a}),builder:On(),context:t,event:s,rootSetState:o,rootState:r,localState:n};try{return Yn(d)}catch(v){W.logger.error("Failed code evaluation: "+v.message,{code:e});return}}function eo(e,t){var n;return{...(n=e.component)==null?void 0:n.options,...e.options,...to(e,t)}}const to=(e,t)=>{var n,r;if(((n=e.component)==null?void 0:n.name)==="Text"&&((r=e.component.options)!=null&&r.text)&&typeof e.component.options.text=="string")return{...e.component.options,text:e.component.options.text.replace(/{{([^}]+)}}/g,(o,s)=>Ye({code:s,context:t,localState:t.localState,rootState:t.rootState,rootSetState:t.rootSetState}))}};function ro(e,...t){const n=Object.assign({},e);for(const r of t)delete n[r];return n}function it(e,t,n=null,r=null,o=new WeakSet){if(e==null||typeof e!="object"){t(e,s=>{n!==null&&r!==null&&(n[r]=s)});return}o.has(e)||(o.add(e),Array.isArray(e)?e.forEach((s,a)=>{t(s,d=>{e[a]=d}),it(s,t,e,a,o)}):Object.entries(e).forEach(([s,a])=>{t(a,d=>{e[s]=d}),it(a,t,e,s,o)}))}function Jr(e){return e&&typeof e=="object"&&e["@type"]==="@builder.io/core:LocalizedValue"}function no(e){if(!e||!Object.getOwnPropertyNames(e).length)return!1;let t=!1;return it(e,n=>{if(Jr(n)){t=!0;return}}),t}function oo(e,t){return!e||!Object.getOwnPropertyNames(e).length?{}:(it(e,(n,r)=>{var o;Jr(n)&&r((o=n[t])!=null?o:void 0)}),e)}function io(e,t){var n,r;return(n=e.component)!=null&&n.options&&no((r=e.component)==null?void 0:r.options)&&(t||console.warn("[Builder.io] In order to use localized fields in Builder, you must pass a locale prop to the BuilderComponent or to options object while fetching the content to resolve localized fields. Learn more: https://www.builder.io/c/docs/localization-inline#targeting-and-inline-localization"),e.component.options=oo(e.component.options,t!=null?t:"Default")),e}const Zt=e=>JSON.parse(JSON.stringify(e)),Kr=(e,t,n)=>{if(Object(e)!==e)return e;const r=Array.isArray(t)?t:t.toString().match(/[^.[\]]+/g);return r.slice(0,-1).reduce((o,s,a)=>Object(o[s])===o[s]?o[s]:o[s]=Math.abs(Number(r[a+1]))>>0===+r[a+1]?[]:{},e)[r[r.length-1]]=n,e};function Ut(e){if(e===null||typeof e!="object")return e;if(Array.isArray(e))return e.map(n=>Ut(n));if(e["@type"]==="@builder.io/sdk:Element")return e;const t={};for(const n in e)n!=="meta"&&Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=Ut(e[n]));return t}const so=["svelte","vue","angular","qwik","solid"].includes(W.TARGET),ao=e=>{if(so){const t=Zt(e);return{...t,properties:{...t.properties},actions:{...t.actions}}}else{const t=Ut(ro(e,"children","meta"));return{...t,properties:{...t.properties},actions:{...t.actions},children:e.children,meta:e.meta}}},lo=({block:e,context:t,localState:n,rootState:r,rootSetState:o})=>{if(!e.bindings)return e;const s=ao(e);for(const a in e.bindings){const f=e.bindings[a],d=Ye({code:f,localState:n,rootState:r,rootSetState:o,context:t});Kr(s,a,d)}return s};function uo({block:e,context:t,localState:n,rootState:r,rootSetState:o}){let s=e;return s=lo({block:s,localState:n,rootState:r,rootSetState:o,context:t}),s=io(s,r.locale),s}const lt=e=>e?e.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase():"";function co(e,t,n={}){let r,o,s,a=null,f=0;const d=function(){f=n.leading===!1?0:Date.now(),a=null,s=e.apply(r,o),a||(r=o=null)};return function(){const v=Date.now();!f&&n.leading===!1&&(f=v);const T=t-(v-f);return r=this,o=arguments,T<=0||T>t?(a&&(clearTimeout(a),a=null),f=v,s=e.apply(r,o),a||(r=o=null)):!a&&n.trailing!==!1&&(a=setTimeout(d,T)),s}}function Xe(e,...t){const n=Object(e);for(let r=1;r<arguments.length;r++){const o=arguments[r];if(o!=null)for(const s in o)Object.prototype.hasOwnProperty.call(o,s)&&(n[s]=o[s])}return n}function fo(e){for(const t of e)switch(t.trigger){case"pageLoad":qr(t);break;case"scrollInView":ho(t);break}}function Yr(e){console.warn(`Cannot animate element: element with ID ${e} not found!`)}function Zr(e,t){const n=po(e),r=getComputedStyle(t),o=e.steps[0].styles,s=e.steps[e.steps.length-1].styles,a=[o,s];for(const f of a)for(const d of n)d in f||(f[d]=r[d])}function po(e){const t=[];for(const n of e.steps)for(const r in n.styles)t.indexOf(r)===-1&&t.push(r);return t}function qr(e){const t=Array.prototype.slice.call(document.getElementsByClassName(e.elementId||e.id||""));if(!t.length){Yr(e.elementId||e.id||"");return}Array.from(t).forEach(n=>{Zr(e,n),n.style.transition="none",n.style.transitionDelay="0",Xe(n.style,e.steps[0].styles),setTimeout(()=>{n.style.transition=`all ${e.duration}s ${lt(e.easing)}`,e.delay&&(n.style.transitionDelay=e.delay+"s"),Xe(n.style,e.steps[1].styles),setTimeout(()=>{n.style.transition="",n.style.transitionDelay=""},(e.delay||0)*1e3+e.duration*1e3+100)})})}function ho(e){const t=Array.prototype.slice.call(document.getElementsByClassName(e.elementId||e.id||""));if(!t.length){Yr(e.elementId||e.id||"");return}Array.from(t).forEach(n=>{Zr(e,n);let r=!1,o=!1;function s(){!r&&f(n)?(r=!0,o=!0,setTimeout(()=>{Xe(n.style,e.steps[1].styles),e.repeat||document.removeEventListener("scroll",a),setTimeout(()=>{o=!1,e.repeat||(n.style.transition="",n.style.transitionDelay="")},(e.duration+(e.delay||0))*1e3+100)})):e.repeat&&r&&!o&&!f(n)&&(r=!1,Xe(n.style,e.steps[0].styles))}const a=co(s,200,{leading:!1});function f(T){const I=T.getBoundingClientRect(),G=window.innerHeight,P=(e.thresholdPercent||0)/100*G;return I.bottom>P&&I.top<G-P}const d=e.steps[0].styles;function v(){Xe(n.style,d)}v(),setTimeout(()=>{n.style.transition=`all ${e.duration}s ${lt(e.easing)}`,e.delay&&(n.style.transitionDelay=e.delay+"s")}),document.addEventListener("scroll",a,{capture:!0,passive:!0}),s()})}const Qr=e=>Object.entries(e).map(([n,r])=>{if(typeof r=="string")return`${lt(n)}: ${r};`}).filter(W.checkIsDefined),go=e=>Qr(e).join(`
`),_e=({mediaQuery:e,className:t,styles:n})=>{const r=`.${t} {
    ${go(n)}
  }`;return e?`${e} {
      ${r}
    }`:r};function yo({style:e}){return e}const mo=({block:e,context:t})=>en(yo({style:e.style||{},context:t,block:e}));function en(e){switch(W.TARGET){case"svelte":case"vue":case"solid":case"angular":return Qr(e).join(" ");case"qwik":case"reactNative":case"react":case"rsc":return e}}const tn=(e,t)=>e?t?e.models&&e.models.length>0&&!e.models.includes(t):!1:!0,vo=({block:e,registeredComponents:t,model:n})=>{var s;const r=(s=e.component)==null?void 0:s.name;if(!r)return null;const o=t[r];if(!o||tn(o,n)){console.warn(`
  ...
  align-items: stretch;
}`}),x.jsx(e.BlocksWrapper,{ref:t,className:n()+" props-blocks-wrapper-b46bf284","builder-path":r(),"builder-parent-id":e.parent,style:e.styleProp,onClick:a=>o(),onMouseEnter:a=>s(),onKeyPress:a=>o(),...e.BlocksWrapperProps,children:e.children})]})}function an(e){var r,o,s;const t=$.useContext(Fr.BuilderContext),n=$.useContext(Lr);return x.jsxs(Bo,{blocks:e.blocks,parent:e.parent,path:e.path,styleProp:e.styleProp,BlocksWrapperProps:e.BlocksWrapperProps||((r=e.context)==null?void 0:r.BlocksWrapperProps)||(t==null?void 0:t.BlocksWrapperProps),classNameProp:e.className,BlocksWrapper:((o=e.context)==null?void 0:o.BlocksWrapper)||(t==null?void 0:t.BlocksWrapper),children:[e.children,e.blocks?x.jsx(x.Fragment,{children:(s=e.blocks)==null?void 0:s.map(a=>x.jsx(ut,{block:a,linkComponent:e.linkComponent,context:e.context||t,registeredComponents:e.registeredComponents||(n==null?void 0:n.registeredComponents)},a.id))}):null]})}const Mo=Object.freeze(Object.defineProperty({__proto__:null,default:an},Symbol.toStringTag,{value:"Module"}));exports.Blocks=an;exports.ComponentsContext=Lr;exports.InlinedStyles=on;exports.blocks=Mo;exports.evaluate=Ye;exports.fastClone=Zt;exports.get=Wr;exports.getSizesForBreakpoints=nn;exports.mapStyleObjToStrIfNeeded=en;exports.set=Kr;exports.triggerAnimation=qr;
